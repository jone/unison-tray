# added as per: https://mail.python.org/pipermail/distutils-sig/2013-February/019810.html
#
...
#
# In the long run, you'll want to change your buildouts to use zc.recipe.egg
# instead."
#
